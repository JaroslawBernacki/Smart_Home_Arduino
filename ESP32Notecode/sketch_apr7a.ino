...
void loop()
{
  ...
  if (SerialBT.available()){
      ...
      if (incomingChar != '\n'){
        ...
        messageinternalcache += String(incomingChar);
      }
      else{
        message = "";
      }
  ...
  if (message =="Image1"){
    Paint_SelectImage(BlackImage);
    //Paint_Clear(WHITE);
    //Serial.write("W petli 1");
    Paint_DrawString_EN(5, 5, "Obraz 1", &Font16, BLACK, WHITE);
    EPD_2IN13D_Display(BlackImage);
    message = "";
    messageinternalcache = "";
  }
  else if (message =="Image2"){
    Paint_SelectImage(BlackImage);
    Paint_Clear(WHITE);
    //Serial.write("W petli 2");
    Paint_DrawString_EN(5, 5, "Obraz 2", &Font16, BLACK, WHITE);
    EPD_2IN13D_Display(BlackImage);
    message = "";
    messageinternalcache = "";
  }
    else if (message =="Image3"){
    Paint_SelectImage(BlackImage);
    Paint_Clear(WHITE);
    Paint_DrawPoint(5, 10, BLACK, DOT_PIXEL_1X1, DOT_STYLE_DFT);
    Paint_DrawPoint(5, 25, BLACK, DOT_PIXEL_2X2, DOT_STYLE_DFT);
  ...
  else if (message==""&&messageinternalcache!=""&&messageinternalcache!="Image4"&&messageinternalcache!="Image3"&&messageinternalcache!="Image2"&&messageinternalcache!="Image1")
  {
    Serial.write("WEGOTHERE");
    Paint_SelectImage(BlackImage);
    Paint_Clear(WHITE);
    const char* converted = messageinternalcache.c_str();
    Paint_DrawString_EN(5, 5, converted, &Font16, BLACK, WHITE);
    EPD_2IN13D_Display(BlackImage);
    messageinternalcache = "";
  }
  delay(20);
